...
def calculate_trip_cost():
    ...
    for _destination, _month, _days in a:
        # print(f'{_destination} - {_month} - {_days}')
        for _first, _last, _class_b, _meal in b:
            # print(f'{_first} {_last} {_class_b} {_meal}')
...
# a = [['Italy', 'January', 2], ['Singapore', 'February', 3]]
# b = [['Diogo', 'Jota', 'Business', 'Veg'], ['Mohamed', 'Salah', 'Economy', 'Non-Veg']]
